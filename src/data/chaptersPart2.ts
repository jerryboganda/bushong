...
export const CHAPTERS_PART2: Chapter[] = [
  {
    number: 5,
    title: 'The X-ray Imaging System',
    partId: 'part2',
    partTitle: 'Part II: X-Radiation',
    pages: 'Pages 84–103',
    objectives: [
      'Identify the three principal components of the x-ray imaging system: operating console, x-ray tube, and high-voltage generator.',
      'Explain the operation of the autotransformer and the autotransformer law.',
      'Describe kVp adjustment, mA control via precision resistors, and the filament circuit.',
      'Compare exposure timers: synchronous, electronic, mAs, and automatic exposure control (AEC).',
      'Explain voltage rectification using solid-state p-n junction diodes (half-wave vs full-wave).',
      'Relate the differences and voltage ripples of single-phase, three-phase, and high-frequency power.',
      'Calculate high-voltage generator power rating in kilowatts (kW).'
    ],
    outline: [
      'Operating Console (kVp, mA, exposure time, line compensation)',
      'Autotransformer (Single winding, primary and secondary taps, law)',
      'kVp Selection (Prereading voltmeter)',
      'mA Selection & Filament Circuit (Thermionic emission, space-charge compensator, step-down transformer)',
      'Exposure Timers (Synchronous, electronic, mAs, AEC with ionization chambers)',
      'High-Voltage Generator (Step-up transformer, turns ratio 500:1 to 1000:1)',
      'Voltage Rectification (Solid-state p-n diodes, half-wave vs full-wave 120 pulses/s)',
      'Power Sources (Single-phase 100% ripple, 3-phase 6-pulse 14% ripple, 3-phase 12-pulse 4% ripple, high-frequency <1% ripple)',
      'Capacitor Discharge & Falling Load Generators',
      'Power Rating Calculations'
    ],
    penguins: [
      {
        id: 'p-5-1',
        title: 'Radiation Quantity and Quality',
        content: 'Radiation quantity is x-ray intensity (measured in mGya or mGya/mAs); radiation quality is x-ray penetrability (expressed in kVp or HVL).',
        chapterNumber: 5
      },
      {
        id: 'p-5-2',
        title: 'Autotransformer Function',
        content: 'The autotransformer has a single winding and is designed to supply a precise, variable voltage to the filament circuit and the high-voltage step-up transformer.',
        chapterNumber: 5
      },
      {
        id: 'p-5-3',
        title: 'Thermionic Emission and mA Control',
        content: 'Thermionic emission is the boiling off of electrons from a heated filament. The filament current (3 to 6 A) controls the x-ray tube current (measured in mA).',
        chapterNumber: 5
      },
      {
        id: 'p-5-4',
        title: 'Rectification Necessity',
        content: 'Voltage rectification is required to ensure that electrons flow from the x-ray tube cathode to anode only, converting AC to DC.',
        chapterNumber: 5
      },
      {
        id: 'p-5-5',
        title: 'Voltage Ripple and Efficiency',
        content: 'Less voltage ripple results in greater radiation quantity and quality. Single-phase has 100% ripple; 3-phase 12-pulse has 4% ripple; high-frequency has <1% ripple.',
        chapterNumber: 5
      },
      {
        id: 'p-5-6',
        title: 'Power Rating Equation',
        content: 'High-voltage generator power (kW) = [maximum tube current (mA) at 100 kVp and 100 ms] / 1000 for 3-phase and high-frequency (multiply by 0.7 for single-phase).',
        chapterNumber: 5
      }
    ],
    formulas: [
      {
        id: 'f-autotransformer',
        name: 'Autotransformer Law',
        formula: 'V_s / V_p = N_s / N_p',
        variables: [
          { symbol: 'V_s', meaning: 'Secondary voltage to high-voltage section', unit: 'V' },
          { symbol: 'V_p', meaning: 'Primary voltage (usually 220 V)', unit: 'V' },
          { symbol: 'N_s', meaning: 'Number of tapped secondary turns', unit: 'windings' },
          { symbol: 'N_p', meaning: 'Number of primary enclosed turns', unit: 'windings' }
        ],
        description: 'Governs the stepped voltage delivered from the autotransformer to the primary side of the high-voltage step-up transformer.',
        chapterNumber: 5
      },
      {
        id: 'f-power-rating-3p',
        name: 'Power Rating (3-Phase & High-Frequency)',
        formula: 'Power (kW) = (mA × kVp) / 1000',
        variables: [
          { symbol: 'Power', meaning: 'Generator power rating', unit: 'kilowatts (kW)' },
          { symbol: 'mA', meaning: 'Maximum tube current at 100 kVp & 100 ms', unit: 'mA' },
          { symbol: 'kVp', meaning: '100 kVp standard', unit: 'kVp' }
        ],
        description: 'Industry standard for rating 3-phase and high-frequency x-ray generators.',
        chapterNumber: 5,
        calculatorId: 'power-rating'
      },
      {
        id: 'f-power-rating-1p',
        name: 'Power Rating (Single-Phase)',
        formula: 'Power (kW) = 0.7 × (mA × kVp) / 1000',
        variables: [
          { symbol: 'Power', meaning: 'Generator power rating', unit: 'kW' },
          { symbol: '0.7', meaning: 'De-rating factor for 100% voltage ripple', unit: 'constant' }
        ],
        description: 'Single-phase power rating incorporates a 0.7 factor due to 100% voltage ripple.',
        chapterNumber: 5
      }
    ],
    sections: [
      {
        id: 'c5-s1',
        title: 'The Operating Console',
        paragraphs: [
          'The operating console allows the radiologic technologist to control the x-ray tube current (mA), tube voltage (kVp), and exposure time. Meters and digital displays monitor these values. All console circuits are low-voltage to prevent electrical shock.',
          'Line compensation: Supply voltage from power companies can fluctuate by up to 5%. The line compensator measures input voltage and automatically adjusts it to precisely 220 V.'
        ]
      },
      {
        id: 'c5-s2',
        title: 'Autotransformer and Voltage Selection',
        paragraphs: [
          'Power is delivered first to the autotransformer. Operating on self-induction, it has a single copper winding on an iron core with multiple taps. The primary voltage (220 V) is stepped up or down (100 to 400 V) to provide the exact input to the high-voltage step-up transformer.',
          'The kVp meter is positioned across the autotransformer output terminals. It is a prereading meter, allowing voltage to be monitored before an exposure is made.'
        ]
      },
      {
        id: 'c5-s3',
        title: 'Filament Circuit and mA Control',
        paragraphs: [
          'X-ray tube current (measured in mA) flows from cathode to anode. The filament current (3 to 6 A) heats the filament, causing thermionic emission. A small change in filament current produces a large increase in tube current.',
          'The filament heating isolation step-down transformer steps voltage down to ~12 V while stepping current up to 5 to 8 A. The mA meter is placed at the center tap of the secondary winding of the high-voltage step-up transformer, where electric potential is always zero volts, ensuring complete operator safety.'
        ]
      },
      {
        id: 'c5-s4',
        title: 'Exposure Timers and Automatic Exposure Control (AEC)',
        paragraphs: [
          'The timer circuit makes and breaks the high-voltage primary circuit. Synchronous timers drive a shaft at 60 rps (minimum exposure 1/60 s). Electronic timers are microprocessor-controlled and accurate to 1 ms.',
          'Automatic Exposure Control (AEC) uses a radiolucent flat parallel-plate ionization chamber placed between the patient and the image receptor. Ionization charges a capacitor; when the preset reference level is reached, the exposure is terminated. A 600-mAs backup timer acts as a safety cutoff.'
        ]
      },
      {
        id: 'c5-s5',
        title: 'High-Voltage Generators, Rectification & Waveforms',
        paragraphs: [
          'The high-voltage step-up transformer has a turns ratio of 500:1 to 1000:1. Voltage is stepped up to kilovolts while current is stepped down to milliamperes.',
          'Solid-state rectifiers (silicon p-n junction diodes) convert AC to DC so electrons flow only cathode to anode. Half-wave rectification uses 0, 1, or 2 diodes, producing 60 pulses/s (wastes half the power). Full-wave rectification uses at least 4 diodes arranged in a bridge, producing 120 pulses/s and halving exposure times.',
          'Three-phase 6-pulse has 14% ripple; 3-phase 12-pulse has 4% ripple; high-frequency generators use high-speed inverter choppers (500 to 25,000 Hz) to produce <1% ripple with superior beam quality and reduced patient dose.'
        ]
      }
    ],
    summary: [
      'The x-ray imaging system consists of operating console, x-ray tube, and high-voltage generator.',
      'The autotransformer supplies precise primary voltage to both high-voltage and filament circuits.',
      'Full-wave rectification produces 120 pulses per second, cutting exposure time in half compared to half-wave.',
      'High-frequency generators provide nearly constant potential (<1% ripple), smaller footprint, and higher x-ray production efficiency.'
    ],
    challengeQuestions: [
      {
        id: "q5-1",
  ...
  },
  {
    ...
    pages: 'Pages 104–121',
    objectives: [
      'Describe the general design, support structures, and protective housing of the x-ray tube.',
      'Identify the leakage radiation limit (<1 mGya/h at 1 m).',
      'Explain the purpose and construction of the glass or metal enclosure.',
      'Describe the cathode, thoriated tungsten filament, focusing cup, and space-charge effect.',
      'Describe the rotating anode, tungsten-rhenium target disc, and electromagnetic induction motor.',
      'Explain the line-focus principle and the anode heel effect.',
      'Identify the three major causes of x-ray tube failure.',
      'Interpret radiographic rating charts and anode cooling charts.'
    ],
    outline: [
      'External Components (Support systems: Ceiling, Floor-to-ceiling, C-arm)',
      'Protective Housing (Leakage radiation limit, high-voltage receptacles, insulating oil)',
      'Glass vs Metal Enclosure (Vacuum maintenance, tungsten vaporization & arcing prevention)',
      'Internal Components: Cathode (Filament, thermionic emission, thoriated tungsten, focusing cup, space-charge effect, saturation current, dual focal spots)',
      'Internal Components: Anode (Stationary vs rotating, tungsten target alloyed with rhenium, molybdenum stem, induction motor stators and rotor)',
      'Line-Focus Principle (Actual focal spot vs effective focal spot, target angles 5° to 20°)',
      'Anode Heel Effect (Cathode side intensity higher, application in chest and abdomen positioning)',
      'Off-Focus (Extrafocal) Radiation and Diaphragm Fixes',
      'X-ray Tube Failure (Thermal causes, surface melting/pitting, bearing damage, open filament)',
      'Rating Charts (Radiographic rating chart, Anode cooling chart, Heat unit calculations)'
    ],
    penguins: [
      {
        id: 'p-6-1',
        title: 'Leakage Radiation Limit',
        content: 'Properly designed protective housing reduces the level of leakage radiation to less than 1 mGya/h at 1 m (100 mR/h at 1 m) when operated at maximum conditions.',
        chapterNumber: 6
      },
      {
        id: 'p-6-2',
        title: 'Tungsten Vaporization Cause of Failure',
        content: 'Tungsten vaporization with deposition on the inside of the glass enclosure is the most common cause of abrupt tube failure (causing arcing). Metal enclosures prevent this.',
        chapterNumber: 6
      },
      {
        id: 'p-6-3',
        title: 'Why Tungsten is Target Material of Choice',
        content: 'Tungsten is chosen for: 1. High atomic number (Z=74) for high-efficiency x-ray production. 2. High thermal conductivity (dissipates heat). 3. High melting point (3410°C) to withstand extreme tube currents.',
        chapterNumber: 6
      },
      {
        id: 'p-6-4',
        title: 'Line-Focus Principle',
        content: 'The line-focus principle results in an effective focal spot size much smaller than the actual focal spot size by angling the target (5° to 20°), improving spatial resolution while retaining heat capacity.',
        chapterNumber: 6
      },
      {
        id: 'p-6-5',
        title: 'Anode Heel Effect Rule',
        content: 'The heel effect results in smaller effective focal spot and reduced radiation intensity on the anode side (up to 45% variance). Always position the cathode over thicker anatomy!',
        chapterNumber: 6
      },
      {
        id: 'p-6-6',
        title: 'Heat Unit Formulas',
        content: 'Single-phase: HU = kVp × mA × s. Three-phase/High-frequency: HU = 1.4 × kVp × mA × s (1 HU = 1.4 Joules). Maximum techniques must never be applied to a cold anode.',
        chapterNumber: 6
      }
    ],
    formulas: [
      {
        id: 'f-heat-units-1p',
        name: 'Heat Units (Single-Phase)',
        formula: 'HU = kVp × mA × s = kVp × mAs',
        variables: [
          { symbol: 'HU', meaning: 'Heat Units generated', unit: 'HU' },
          { symbol: 'kVp', meaning: 'Kilovolt peak', unit: 'kVp' },
          { symbol: 'mA', meaning: 'Tube current', unit: 'mA' },
          { symbol: 's', meaning: 'Exposure time', unit: 'seconds' }
        ],
        description: 'Calculates thermal energy deposited on an x-ray tube anode with single-phase power. 1 HU = 0.7 Joules.',
        chapterNumber: 6,
        calculatorId: 'heat-units'
      },
      {
        id: 'f-heat-units-3p',
        name: 'Heat Units (3-Phase & High-Frequency)',
        formula: 'HU = 1.4 × kVp × mA × s = 1.4 × kVp × mAs',
        variables: [
          { symbol: 'HU', meaning: 'Heat Units generated', unit: 'HU' },
          { symbol: '1.4', meaning: 'Constant accounting for nearly continuous high voltage', unit: 'constant' }
        ],
        description: 'Calculates thermal energy with 3-phase or high-frequency power. 1 HU = 1.4 J (1 Joule = 1 HU).',
        chapterNumber: 6,
        calculatorId: 'heat-units'
      }
    ],
    sections: [
      {
        id: 'c6-s1',
        title: 'External Structure of the X-ray Tube',
        paragraphs: [
          'The x-ray tube is supported by ceiling cranes, floor-to-ceiling columns, or C-arms. When centered over the table at standard SID, it sits in a preferred detent position.',
          'The protective housing provides mechanical support, protects against rough handling, and shields against excessive radiation leakage (<1 mGya/h at 1 m). It contains insulating oil that serves as a thermal cushion and dielectric insulator.',
          'Glass enclosures (Pyrex) maintain the vacuum essential for x-ray production. Over time, vaporized tungsten deposits on the glass, causing arcing. Modern high-capacity tubes use metal enclosures to maintain constant electric potential and eliminate arcing.'
        ]
      },
      {
        id: 'c6-s2',
        title: 'The Cathode: Filaments and Focusing Cup',
        paragraphs: [
          'The cathode is the negative electrode containing one or two filaments and a focusing cup. Filaments are coils of thoriated tungsten (~2 mm diameter, 1–2 cm long). Adding 1–2% thorium increases thermionic efficiency and extends tube life.',
          'The negatively charged nickel focusing cup electrostatically condenses the electron beam to a small focal track on the anode. Space charge effect occurs when emitted electrons form an electrostatic repulsion cloud around the filament at low kVp and high mA.',
          'Most diagnostic tubes are dual-focus (e.g., 0.6 mm small for high resolution / 1.2 mm large for high heat loads).'
        ]
      },
      {
        id: 'c6-s3',
        title: 'The Anode: Target and Induction Motor',
        paragraphs: [
          'The anode is the positive electrode. Stationary anodes (used in dental and low-power units) use tungsten embedded in copper. Rotating anodes (used in general radiography) use a rotating disc (3400 to 10,000 rpm) providing ~500 times more area to dissipate heat.',
          'The target is tungsten alloyed with rhenium (for mechanical strength) backed by molybdenum and graphite. The anode stem is narrow molybdenum because molybdenum is a poor heat conductor, protecting the rotor bearings.',
          'The anode is rotated by an induction motor. External stator electromagnets sequentially energize, inducing a magnetic field that spins the internal copper/iron rotor.'
        ]
      },
      {
        id: 'c6-s4',
        title: 'Line-Focus Principle and Heel Effect',
        paragraphs: [
          'The line-focus principle uses an angled anode target (5° to 20°) so the effective focal spot projected onto the patient is much smaller than the actual area of electron interaction, improving spatial resolution while retaining high heat capacity.',
          'The Anode Heel Effect causes radiation intensity to be higher on the cathode side (up to 120%) than on the anode side (as low as 75%) because x-rays emitted towards the anode traverse a greater thickness of target material ("heel"). Rule of thumb: position the cathode over the thicker body part (e.g., cathode inferior for chest, superior for abdomen).',
          'Off-focus (extrafocal) radiation occurs when rebounding electrons strike areas outside the focal spot. It is reduced by internal fixed diaphragms near the tube window.'
        ]
      },
      {
        id: 'c6-s5',
        title: 'Tube Failure and Rating Charts',
        paragraphs: [
          'Causes of tube failure: 1. A single massive exposure on a cold anode causes surface melting, pitting, or cracking. Always warm up a cold anode! 2. Prolonged elevated temperatures damage rotor bearings. 3. Filament vaporization leads to thinning, open filament, or glass arcing.',
          'Radiographic rating charts plot kVp vs time for each mA station; exposures below the curve are safe. Anode cooling charts indicate thermal capacity (in Heat Units) and cooling rate over time.'
        ]
      }
    ],
    summary: [
      'The x-ray tube is an electronic vacuum diode with cathode (-) and rotating anode (+).',
      'Protective housing limits leakage radiation to <1 mGya/h at 1 m.',
      'Tungsten is the target material of choice due to high Z (74), high thermal conductivity, and high melting point (3410°C).',
      'The line-focus principle angles the anode to produce a small effective focal spot.',
      'The anode heel effect produces greater beam intensity on the cathode side; position cathode to thicker anatomy.',
      'Always use warm-up procedures on cold anodes to prevent cracking.'
    ],
    challengeQuestions: [
      {
        id: "q6-1",
  ...
  },
  {
    ...
    objectives: [
      ...
      'Explain anode heat production and efficiency of x-ray production.',
      'Describe characteristic x-ray production and discrete energy values for tungsten.',
      'Explain bremsstrahlung x-ray production and the continuous spectrum.',
      'Describe the complete x-ray emission spectrum.',
      'Analyze how mA, mAs, kVp, added filtration, target material, and voltage waveform affect the spectrum.'
    ],
    outline: [
      'Electron Target Interactions (Kinetic energy, velocity = 1.6 × 10⁸ m/s at 70 kVp)',
      'Anode Heat Production (~99% heat, ~1% x-rays at diagnostic energies)',
      'Characteristic Radiation (Inner K-shell ionization, electron transitions, discrete spectrum at 69 keV for W)',
      'Bremsstrahlung Radiation (Braking by nuclear electric field, continuous spectrum up to peak kVp)',
      'X-ray Emission Spectrum (Discrete vs continuous)',
      'Factors Affecting Emission Spectrum (mA/mAs amplitude, kVp amplitude & shift, filtration beam hardening, target Z, voltage waveform efficiency)'
    ],
    penguins: [
      {
        id: 'p-7-1',
        title: 'Anode Heat Inefficiency',
        content: 'Approximately 99% of the kinetic energy of electrons from the cathode is converted into heat; only ~1% is converted into x-rays at diagnostic energies.',
        chapterNumber: 7
      },
      {
        id: 'p-7-2',
        title: 'Characteristic Radiation Mechanism',
        content: 'Characteristic x-rays are emitted when an outer-shell electron fills an inner-shell void. Only the K-characteristic x-rays of tungsten (effective energy ~69 keV) are useful for imaging.',
        chapterNumber: 7
      },
      {
        id: 'p-7-3',
        title: 'Bremsstrahlung Predominance',
        content: 'In the diagnostic range, most x-rays are bremsstrahlung x-rays ("slowed-down radiation"). Below 69 kVp, 100% of the tungsten x-ray beam is bremsstrahlung.',
        chapterNumber: 7
      },
      {
        id: 'p-7-4',
        title: '15% Rule in Spectrum',
        content: 'In the diagnostic range, a 15% increase in kVp is equivalent to doubling the mAs to the image receptor.',
        chapterNumber: 7
      },
      {
        id: 'p-7-5',
        title: 'Target Atomic Number Effect',
        content: 'Increasing target atomic number enhances the efficiency of x-ray production and shifts both characteristic and bremsstrahlung spectra to higher energies.',
        chapterNumber: 7
      }
    ],
    formulas: [
      {
        id: 'f-min-wavelength',
        name: 'Duane-Hunt Law (Minimum Wavelength)',
        formula: 'λ_min = 1.24 / kVp  (in nanometers)  or  λ_min = 12.4 / kVp  (in Angstroms)',
        variables: [
          { symbol: 'λ_min', meaning: 'Minimum x-ray wavelength', unit: 'nm or Å' },
          { symbol: 'kVp', meaning: 'Peak tube potential', unit: 'kilovolts' }
        ],
        description: 'Maximum x-ray energy is numerically equal to the operating kVp, corresponding to the shortest emitted wavelength.',
        chapterNumber: 7
      }
    ],
    sections: [
      {
        id: 'c7-s1',
        title: 'Electron Target Interactions and Anode Heat',
        paragraphs: [
          'Projectile electrons accelerated across a 1-cm gap from cathode to anode reach over half the speed of light (1.6 × 10⁸ m/s at 70 kVp).',
          'Over 99% of electron kinetic energy is converted to heat via excitation of outer-shell target electrons, which emit infrared radiation. Efficiency of x-ray production is independent of tube current but increases with kVp (~0.5% at 60 kVp, 1% at 100 kVp, 70% at 20 MV).'
        ]
      },
      {
        id: 'c7-s2',
        ...
        paragraphs: [
          'When a high-speed electron knocks out an inner K-shell electron of a tungsten atom (Eb = 69.5 keV), an outer-shell electron drops down to fill the vacancy, emitting a characteristic photon equal to the difference in binding energies.',
          'Transitions from L to K yield 57.5 keV; M to K yield 66.7 keV; N to K yield 68.9 keV. These 15 discrete lines are represented collectively as a single discrete line at ~69 keV on the tungsten spectrum. L x-rays (~12 keV) lack energy to penetrate tissue and do not contribute to the diagnostic image.'
        ]
      },
      {
        id: 'c7-s3',
        ...
        paragraphs: [
          'When a projectile electron avoids orbital electrons and approaches the nucleus, the nuclear electrostatic field brakes and deflects the electron, transforming lost kinetic energy into a bremsstrahlung photon.',
          'Bremsstrahlung x-rays form a continuous spectrum from 0 up to the maximum operating kVp. Peak x-ray emission occurs at approximately one-third of the maximum energy (e.g., at 90 kVp, the highest number of photons have ~30 keV).'
        ]
      },
      {
        id: 'c7-s4',
        title: 'Factors Influencing the Emission Spectrum',
        paragraphs: [
          '1. mA / mAs: Changes amplitude proportionally at all energies; no change in spectrum shape or position.',
          '2. kVp: Increases amplitude and shifts the curve to the right (higher average energy); maximum energy equals kVp.',
          '3. Added filtration: Absorbs low-energy photons preferentially ("beam hardening"), decreasing overall amplitude while shifting the average energy to the right.',
          '4. Target material: Higher Z (e.g., gold Z=79 vs tungsten Z=74) increases bremsstrahlung efficiency and shifts the discrete line to the right. Molybdenum (Z=42) produces characteristic lines at 17.5 and 19.6 keV for mammography.',
          '5. Voltage waveform: High-frequency and 3-phase generators operate with much less ripple, producing higher amplitude and higher average energy than single-phase.'
        ],
        tableData: {
          title: 'Changes in X-ray Beam Quality and Quantity Produced by Various Factors',
          headers: ['Factor Increased', 'Effect on X-ray Quantity', 'Effect on X-ray Quality'],
          rows: [
            ['Tube Current (mA or mAs)', 'Increased proportionally', 'No change'],
            ['Tube Potential (kVp)', 'Increased (proportional to kVp²)', 'Increased (higher average energy)'],
            ['Added Filtration', 'Decreased (attenuated low-energy)', 'Increased (beam hardening)'],
            ['Target Atomic Number (Z)', 'Increased', 'Increased'],
            ['Voltage Ripple', 'Decreased', 'Decreased']
          ]
        }
      }
    ],
    summary: [
      'Projectile electrons interact with target atoms producing heat (~99%), characteristic x-rays, and bremsstrahlung x-rays.',
      'Characteristic x-rays have discrete energies; only tungsten K x-rays (~69 keV) are diagnostically useful.',
      'Bremsstrahlung x-rays have a continuous spectrum with maximum energy equal to peak kVp and peak output at 1/3 peak energy.',
      'Spectrum amplitude is controlled by mAs; amplitude and energy position are controlled by kVp, filtration, target Z, and generator waveform.'
    ],
    challengeQuestions: [
      {
        id: "q7-1",
  ...
  },
  {
    ...
    pages: 'Pages 135–145',
    objectives: [
      'Define radiation quantity and its relation to x-ray intensity (mGya).',
      'List and calculate factors that affect x-ray quantity: mAs, kVp, distance (inverse square law), and filtration.',
      'Explain x-ray quality and penetrability.',
      'Define Half-Value Layer (HVL) and describe the experimental steps to measure it.',
      'Differentiate inherent, added, and compensating filtration.'
    ],
    outline: [
      'X-ray Quantity (Intensity, Exposure, Nomogram estimation)',
      'Factors Affecting X-ray Quantity (mAs proportional, kVp² proportional, inverse square law with distance, filtration reduction)',
      'The Square Law for Radiographic Technique',
      'X-ray Quality (Penetrability, Attenuation definition)',
      'Half-Value Layer (HVL) as the Best Specification of Quality',
      'Steps to Determine HVL Experimentally',
      'Factors Affecting X-ray Quality (kVp increases HVL; filtration increases HVL)',
      'Types of Filtration (Inherent ~0.5 mm Al, Added 1–2 mm Al, Compensating filters: wedge, trough, bow-tie)'
    ],
    penguins: [
      {
        id: 'p-8-1',
        title: 'Quantity Proportionality',
        content: 'X-ray quantity is directly proportional to mAs: I₁/I₂ = mAs₁/mAs₂. Doubling mAs doubles x-ray intensity.',
        chapterNumber: 8
      },
      {
        id: 'p-8-2',
        title: 'Quantity Proportional to kVp²',
        content: 'X-ray quantity is proportional to the square of the ratio of kVp: I₁/I₂ = (kVp₁/kVp₂)². In practice, a 15% increase in kVp allows halving mAs for constant optical density.',
        chapterNumber: 8
      },
      {
        id: 'p-8-3',
        title: 'HVL as Best Method for Quality',
        content: 'Half-Value Layer (HVL) is the thickness of absorbing material necessary to reduce the x-ray intensity to half of its original value. HVL is the best method for specifying x-ray quality.',
        chapterNumber: 8
      },
      {
        id: 'p-8-4',
        title: 'Added Filtration Purpose',
        content: 'Adding filtration to the useful x-ray beam removes low-energy nonpenetrating x-rays, reducing patient skin dose while increasing beam quality (HVL).',
        chapterNumber: 8
      }
    ],
    formulas: [
      {
        id: 'f-quantity-mas',
        name: 'X-ray Quantity and mAs',
        formula: 'I₁ / I₂ = mAs₁ / mAs₂',
        variables: [
          { symbol: 'I₁, I₂', meaning: 'X-ray intensities', unit: 'mGya or mR' },
          { symbol: 'mAs₁, mAs₂', meaning: 'Milliampere-second settings', unit: 'mAs' }
        ],
        description: 'Direct proportional relationship between x-ray intensity and tube mAs.',
        chapterNumber: 8,
        calculatorId: 'quantity-mas'
      },
      {
        id: 'f-quantity-kvp',
        name: 'X-ray Quantity and kVp',
        formula: 'I₁ / I₂ = (kVp₁ / kVp₂)²',
        variables: [
          { symbol: 'I₁, I₂', meaning: 'X-ray intensities', unit: 'mGya or mR' },
          { symbol: 'kVp₁, kVp₂', meaning: 'Tube potentials', unit: 'kVp' }
        ],
        description: 'X-ray beam intensity varies with the square of the kilovolt peak.',
        chapterNumber: 8,
        calculatorId: 'quantity-kvp'
      },
      {
        id: 'f-square-law',
        name: 'The Square Law for Technique Adjustment',
        formula: 'mAs₁ / mAs₂ = (SID₁ / SID₂)²  or  mAs₂ = mAs₁ × (SID₂ / SID₁)² ',
        variables: [
          { symbol: 'mAs₁', meaning: 'Original technique', unit: 'mAs' },
          { symbol: 'mAs₂', meaning: 'New technique required', unit: 'mAs' },
          { symbol: 'SID₁', meaning: 'Original distance', unit: 'cm' },
          { symbol: 'SID₂', meaning: 'New distance', unit: 'cm' }
        ],
        description: 'Compensates mAs when distance (SID) changes to maintain constant image receptor exposure.',
        chapterNumber: 8,
        calculatorId: 'square-law'
      }
    ],
    sections: [
      {
        id: 'c8-s1',
        title: 'X-ray Quantity and Factors',
        paragraphs: [
          'X-ray quantity is the number of x-rays in the useful beam, measured in milligray in air (mGya) or mGya/mAs. General-purpose tubes produce ~50 μGya/mAs at 70 kVp at 100 cm SID.',
          'Quantity is directly proportional to mAs. Doubling mAs doubles the electrons hitting the anode and doubles x-rays emitted.',
          'Quantity is proportional to kVp². Increasing kVp increases both efficiency of x-ray production and average energy. When SID increases, intensity drops inversely with distance squared. To maintain constant receptor exposure, mAs must increase by (SID₂/SID₁)² (Square Law).'
        ]
      },
      {
        id: 'c8-s2',
        title: 'X-ray Quality and Half-Value Layer (HVL)',
        paragraphs: [
          'X-ray quality refers to penetrability—the ability of x-rays to penetrate deeper into tissue without being absorbed. High-energy x-rays are high quality; low-energy x-rays are low quality.',
          'Half-Value Layer (HVL) is the thickness of absorbing material (typically mm of aluminum) needed to reduce beam intensity by 50%. Diagnostic x-ray beams typically have HVLs of 3 to 5 mm Al or 3 to 6 cm of soft tissue.'
        ]
      },
      {
        id: 'c8-s3',
        ...
        paragraphs: [
          'Inherent filtration (~0.5 mm Al equivalent) is provided by the glass or metal envelope and x-ray tube window. Special mammography tubes use beryllium (Z=4) windows (~0.1 mm Al eq).',
          'Added filtration consists of sheets of aluminum permanently installed in the collimator port plus the collimator mirror (~1.0 mm Al eq), achieving a total filtration of at least 2.5 mm Al eq for general diagnostic equipment.',
          'Compensating filters (wedge, trough, bow-tie, step-wedge) compensate for anatomical thickness variations to produce uniform optical density (e.g., wedge for foot AP, trough for chest PA).'
        ]
      }
    ],
    summary: [
      'X-ray quantity is intensity in mGya; affected by mAs, kVp², distance (inverse square), and filtration.',
      'The Square Law allows mAs adjustment when SID changes: mAs₁/mAs₂ = SID₁²/SID₂².',
      'X-ray quality is penetrability, best specified by HVL.',
      'Total filtration must be at least 2.5 mm Al eq for systems operating above 70 kVp.'
    ],
    challengeQuestions: [
      {
        id: "q8-1",
  ...
  },
  {
    ...
    objectives: [
      ...
      'Identify the two interactions of diagnostic importance: Compton scattering and photoelectric effect.',
      'Define differential absorption and describe its role in radiographic contrast.',
      'Explain how atomic number (Z) and mass density affect differential absorption.',
      'Discuss positive contrast agents (iodine, barium) and negative contrast agents (air).',
      'Explain exponential x-ray attenuation (attenuation = absorption + scatter).'
    ],
    outline: [
      'Five X-ray Interactions with Matter (Coherent, Compton, Photoelectric, Pair Production, Photodisintegration)',
      'Coherent Scattering (Low energy <10 keV, no ionization, slight scatter)',
      'Compton Scattering (Outer-shell ionization, Compton electron + scattered photon, independent of Z, reduces contrast)',
      'Photoelectric Effect (Inner-shell ionization, total photon absorption, photoelectron ejected, proportional to Z³ and 1/E³)',
      'Pair Production (>1.02 MeV, nuclear field interaction, electron-positron pair, PET imaging)',
      'Photodisintegration (>10 MeV, nuclear excitation and fragment emission)',
      'Differential Absorption (Compton scatter + Photoelectric absorption + Transmitted unattenuated x-rays)',
      'Dependence on Atomic Number (Z³ relationship) & Mass Density',
      'Contrast Examinations (Barium Z=56, Iodine Z=53)',
      'Exponential Attenuation (Attenuation = Absorption + Scatter)'
    ],
    penguins: [
      {
        id: 'p-9-1',
        title: 'Two Diagnostic Interactions',
        content: 'Only Compton scattering and the photoelectric effect are important in diagnostic radiology. Coherent scattering contributes only minor noise; pair production and photodisintegration require mega-electron volt energies.',
        chapterNumber: 9
      },
      {
        id: 'p-9-2',
        title: 'Compton Scattering Properties',
        content: 'The probability of Compton scattering is inversely proportional to x-ray energy (1/E) and independent of atomic number. Compton scatter produces uniform noise and reduces image contrast.',
        chapterNumber: 9
      },
      {
        id: 'p-9-3',
        title: 'Photoelectric Effect Properties',
        content: 'The photoelectric effect is total x-ray absorption. Its probability is directly proportional to the third power of atomic number (Z³) and inversely proportional to the cube of x-ray energy (1/E³).',
        chapterNumber: 9
      },
      {
        id: 'p-9-4',
        title: 'Differential Absorption Definition',
        content: 'Differential absorption occurs because of Compton scattering, photoelectric absorption, and unattenuated transmission through the patient. An x-ray image results from ~0.5% of emitted x-rays.',
        chapterNumber: 9
      },
      {
        id: 'p-9-5',
        title: 'Exponential Attenuation',
        content: 'Attenuation is the product of absorption and scattering. X-rays are attenuated exponentially: they never truly reach zero intensity.',
        chapterNumber: 9
      }
    ],
    formulas: [
      {
        id: 'f-compton',
        name: 'Compton Scattering Energy Balance',
        formula: 'E_i = E_s + (E_b + E_ke)',
        variables: [
          { symbol: 'E_i', meaning: 'Incident x-ray energy', unit: 'keV' },
          { symbol: 'E_s', meaning: 'Scattered x-ray energy', unit: 'keV' },
          { symbol: 'E_b', meaning: 'Electron binding energy', unit: 'keV' },
          { symbol: 'E_ke', meaning: 'Kinetic energy of Compton electron', unit: 'keV' }
        ],
        description: 'Energy conservation in Compton scattering between outer-shell electron and incident photon.',
        chapterNumber: 9
      },
      {
        id: 'f-photoelectric',
        name: 'Photoelectric Effect Energy Balance',
        formula: 'E_ke = E_i - E_b',
        variables: [
          { symbol: 'E_ke', meaning: 'Photoelectron kinetic energy', unit: 'keV' },
          { symbol: 'E_i', meaning: 'Incident photon energy', unit: 'keV' },
          { symbol: 'E_b', meaning: 'K-shell binding energy', unit: 'keV' }
        ],
        description: 'Photoelectric effect can only occur if incident photon energy is equal to or greater than electron binding energy.',
        chapterNumber: 9
      }
    ],
    sections: [
      {
        id: 'c9-s1',
        title: 'The Five X-ray Interactions',
        paragraphs: [
          '1. Coherent (Classical / Thompson) scattering: Incident x-ray (<10 keV) excites atom; photon is re-emitted with same energy but different direction. No ionization occurs.',
          '2. Compton scattering: Moderate-energy x-ray ionizes an outer-shell electron. The ejected Compton electron and scattered photon share the energy. Probability decreases with 1/E and is independent of Z. Scattered photons produce image fog and radiation hazard to personnel.',
          '3. Photoelectric effect: Incident x-ray is totally absorbed by an inner K-shell electron, ejecting a photoelectron (Eke = Ei - Eb). Outer electrons cascade down, emitting characteristic radiation. Probability varies as Z³/E³.',
          '4. Pair production: High-energy photon (>1.02 MeV) interacts with nuclear field, transforming into an electron and a positron (each 0.51 MeV). Basis of PET imaging.',
          '5. Photodisintegration: Extreme energy (>10 MeV) photon is absorbed by nucleus, causing emission of nucleons or nuclear fragments.'
        ]
      },
      {
        id: 'c9-s2',
        ...
        paragraphs: [
          'An x-ray image results from the difference between x-rays absorbed photoelectrically in tissue and x-rays transmitted to the image receptor without interaction. Only ~1% of incident x-rays reach the receptor, and fewer than half interact to form the image (~0.5% image efficiency).',
          'Because bone has Z=13.8 and soft tissue has Z=7.4, photoelectric absorption in bone is (13.8 / 7.4)³ = 6.5 times greater than in soft tissue at equal thickness.',
          'Mass density differences also create contrast: bone (1.85 g/cm³) has nearly twice the mass density of soft tissue (1.0 g/cm³), doubling both Compton and photoelectric interactions. Lung (0.32 g/cm³) transmits ~3 times more x-rays than soft tissue.'
        ]
      },
      {
        id: 'c9-s3',
        title: 'Contrast Media and Exponential Attenuation',
        paragraphs: [
          'Positive contrast agents (Barium Z=56, Iodine Z=53) have high atomic numbers and high mass density, greatly enhancing photoelectric absorption and providing high subject contrast for vascular, GI, and renal imaging.',
          'Negative contrast agents (air, CO₂) have low mass density, allowing x-rays to transmit freely (used in double-contrast colon studies).',
          'X-rays are attenuated exponentially: each increment of tissue thickness reduces the beam intensity by a constant percentage (e.g., 5 cm soft tissue = 1 HVL = 50% attenuation). Attenuation is the sum of absorption and scattering.'
        ]
      }
    ],
    summary: [
      'Diagnostic imaging relies on Compton scattering (noise/fog) and Photoelectric absorption (anatomic contrast).',
      'Photoelectric probability is proportional to Z³/E³; Compton probability is proportional to 1/E and independent of Z.',
      'Differential absorption is enhanced at lower kVp but requires higher patient dose.',
      'Positive contrast media (barium, iodine) accentuate photoelectric effect; air provides negative contrast.',
      'X-ray attenuation is exponential: attenuation = absorption + scatter.'
    ],
    challengeQuestions: [
      {
        id: "q9-1",
